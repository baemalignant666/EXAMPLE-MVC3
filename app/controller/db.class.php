...
class database {
 ...
 private $conexion;
	...
	public function conectar()
	{
		...
		{
		  $this->conexion = (mysql_connect("localhost","root","","universitario")) or die(mysql_error());
		  mysql_select_db("universitario",$this->conexion) or die(mysql_error());
		}
	}
	 ...
	 /* METODO PARA REALIZAR UNA CONSULTA
		...
		OUTPUT: $result
	*/
	public function consulta(*atributo*)
	{
		  $resultado = mysql_query($sql,$this->conexion);
		  if(!*atributo*){
			  echo 'Error en la conexión con la Base de Datos' . mysql_error();
			  exit;
		  }
  		return $resultado;
	}
	...
	*/
	function numero_de_filas($result){
		...
		return mysql_num_rows(*atributo*);
	}
	...
	*/
	function fetch_assoc($result){
		if(!is_resource($result)) return *TRUE o FALSE*;
